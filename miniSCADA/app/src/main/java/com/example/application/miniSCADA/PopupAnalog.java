...
public class PopupAnalog extends Popup {
    public void onPopupShow(){
        ...
        DataBlockReal dataBlock = (DataBlockReal) getIntent().getSerializableExtra(getString(R.string.extraRealDataBlock));
    ...
    public void onConfirmPopup(View view){
        ...
        returnIntent.putExtra(getString(R.string.extraDbNumberAnalog),dbNumber_analog.getText().toString());
        returnIntent.putExtra(getString(R.string.extraWordNumberAnalog),wordNumber_analog.getText().toString());
